...
/**
 * A stream for writing a file into Qingstor. The data will be persisted to a temporary directory on the
...
public class QingstorOutputStream  extends OutputStream {
     ...
     */
    public QingstorOutputStream(Bucket bucket, String key)
            throws IOException {
        ...
        Preconditions.checkArgument(bucket != null,
                "Qingstor bucket must not be null.");
