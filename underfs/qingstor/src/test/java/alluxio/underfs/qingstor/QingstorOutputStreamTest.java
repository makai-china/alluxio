...
/**
 * Unit tests for the {@link QingstorOutputStream}.
 */
@RunWith(PowerMockRunner.class)
public class QingstorOutputStreamTest {
     ...
     */
    @Test
    @PrepareForTest(QingstorOutputStream.class)
    public void testConstructor() throws Exception {
        ...
        new QingstorOutputStream(mBucket, "testKey").close();
    }

    /**
     * Tests to ensure {@link QingstorOutputStream#write(int)} calls {@link OutputStream#write(int)}.
     *
    ...
    public void testWrite1() throws Exception {
        ...
        QingstorOutputStream stream = new QingstorOutputStream(mBucket, "testKey");
        stream.write(1);
        stream.close();
    ...
    /**
     * Tests to ensure {@link QingstorOutputStream#write(byte[], int, int)} calls
    ...
    /**
     * Tests to ensure {@link QingstorOutputStream#write(byte[])} calls {@link OutputStream#write(byte[])}.
     *
     ...
     * {@link Bucket#putObject(String, Bucket.PutObjectInput)} throws an
     * OSSException.
     *
    ...
    public void testCloseError() throws Exception {
        ...
        PowerMockito
                .when(mBucket.putObject(Mockito.anyString(), Mockito.any(Bucket.PutObjectInput.class)))
                .thenThrow(new QSException(errorMessage));
        QingstorOutputStream stream = new QingstorOutputStream(mBucket, "testKey");
        mThrown.expect(IOException.class);
        mThrown.expectMessage(errorMessage);
        stream.close();
     ...
     *
     * @throws Exception when {@link Bucket#putObject(String, Bucket.PutObjectInput)}
    ...
    /**
     * Tests to ensure {@link QingstorOutputStream#flush()} calls {@link OutputStream#flush()}.
     *
